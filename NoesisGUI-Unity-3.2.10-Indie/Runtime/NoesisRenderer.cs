...
public class NoesisRenderer
{
    ...
    private struct ViewProj
    {
        ...
        public Noesis.Matrix4 eyeProjection;
    };

    public static void RenderOnscreen(Noesis.View view_, Noesis.Matrix4 eyeProjection_, bool flipY,
        UnityEngine.Rendering.CommandBuffer commands, bool invalidate, bool clearStencil)
    {
        ...
        var data = new ViewProj() { renderer = view_.Renderer.CPtr.Handle, eyeProjection = eyeProjection_ };
  ...
  #if ENABLE_URP_PACKAGE_RENDER_GRAPH
    public static void RenderOnscreen_(Noesis.View view_, Noesis.Matrix4 eyeProjection_, bool flipY,
    ...
    public static void RenderOnscreen(Noesis.View view_, Noesis.Matrix4 leftEyeProjection_, Noesis.Matrix4 rightEyeProjection_,
        bool flipY, UnityEngine.Rendering.CommandBuffer commands, bool invalidate, bool clearStencil)
    {
        FixCommandBuffer(commands);
        ...
        var data = new ViewStereoProj() { renderer = view_.Renderer.CPtr.Handle, leftEyeProjection = leftEyeProjection_, rightEyeProjection = rightEyeProjection_ };
  ...
  #if ENABLE_URP_PACKAGE_RENDER_GRAPH
    public static void RenderOnscreen_(Noesis.View view_, Noesis.Matrix4 leftEyeProjection_, Noesis.Matrix4 rightEyeProjection_,
        bool flipY, UnityEngine.Rendering.RasterCommandBuffer commands, bool invalidate, bool clearStencil)
    {
        if (clearStencil)
        {
            commands.ClearRenderTarget(UnityEngine.Rendering.RTClearFlags.Stencil, UnityEngine.Color.black, 1.0f, 0);
    ...
    public static void RenderOnscreen_(Noesis.View view_, Noesis.Matrix4 leftEyeProjection_, Noesis.Matrix4 rightEyeProjection_,
        bool flipY, UnityEngine.Rendering.UnsafeCommandBuffer commands, bool invalidate, bool clearStencil)
    {
        if (clearStencil)
        {
            commands.ClearRenderTarget(UnityEngine.Rendering.RTClearFlags.Stencil, UnityEngine.Color.black, 1.0f, 0);
